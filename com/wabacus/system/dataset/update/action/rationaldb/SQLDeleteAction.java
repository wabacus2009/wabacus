...
{
    public SQLDeleteAction(AbsEditableReportEditDataBean ownerUpdateBean)
    {
    ...
    public void parseActionScript(String sql,List<AbsUpdateAction> lstUpdateActions,String reportTypeKey)
    {
        ...
        this.sqlsp=this.ownerUpdateBean.parseStandardEditSql(sql,lstParamBeans,reportTypeKey,this.isPreparedStatement,this.isOriginalParams);
